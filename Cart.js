...
const Cart = () => {
    ...
    //function to rremove items from the cart
    const removeCartItemHandler = (id) => {
        dispatch(removeItemFromCart(id));
    }  

    //function to increase the quantity on an item
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-4 col-lg-2 mt-4 mt-lg-0'>
                                        <p id='cart_item_price'>
                                            <FontAwesomeIcon icon={faIndianRupee} size='x5' />
                                            {item.price}
                                        </p>
                                    </div>
                                    ...
                                    <div className='col-4 col-lg-3 mt-4 mt-lg-0'>
                                        <div className='stockCounter d-inlibe'>
